        ...
        <div class="row">
            <div class="col-12 mt-4">
                <div class="d-grid gap-2 d-md-flex">
                    <a href="{{ route('pages.create') }}" class="btn btn-primary mb-3 btn-sm">
                        Tambah Data +
                    </a>
                </div>
                            ...
                            <tbody>
                                ...
                                @foreach($pages as $page)
                                    <tr>
                                        ...
                                        <td class="p-3"><img src="{{ asset('storage/page/' . $page->image) }}" width="70px" class="img-fluid" alt="image"></td>
                                        <td class="p-3">{{ $page->title }}</td>
                                        <td class="p-3">{{ $page->slug }}</td>
                                        <td style="width: 25%;">
                                            <a href="{{ route('pages.edit', $page->id) }}" class="btn btn-warning btn-sm mb-2"><i class="fa-solid fa-pen"></i> Edit</a>
                                            <button type="button" class="btn btn-danger btn-sm mb-2 btn-delete" data-id="{{ $page->id }}"><i class="fa-solid fa-trash"></i> Hapus</button>
                                        </td>
                                    </tr>
                                @endforeach
                                <!-- End -->
