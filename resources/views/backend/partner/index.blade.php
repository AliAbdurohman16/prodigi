                            ...
                            <tbody>
                                ...
                                @foreach($partners as $partner)
                                    <tr>
                                        ...
                                        <td class="p-3"><img src="{{ asset('storage/partner/' . $partner->image) }}" width="70px" class="img-fluid" alt="image"></td>
                                        <td class="p-3">{{ asset('storage/partner/' . $partner->image) }}</td>
                                        <td style="width: 25%;">
                                            <button type="button" class="btn btn-warning btn-sm mb-2" data-bs-toggle="modal" data-bs-target="#edit-modal{{ $partner->id }}"><i class="fa-solid fa-pen"></i> Edit</button>
                                            <button type="button" class="btn btn-danger btn-sm mb-2 btn-delete" data-id="{{ $partner->id }}"><i class="fa-solid fa-trash"></i> Hapus</button>
                                        </td>
                                    </tr>
                                @endforeach
                                <!-- End -->
...
<!-- Modal Edit -->
@foreach ($partners as $partner)
<div class="modal fade" id="edit-modal{{ $partner->id }}" tabindex="-1" aria-labelledby="LoginForm-title" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content rounded shadow border-0">
            <div class="modal-header border-bottom">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="mb-3">
                                <div class="row">
                                    <div class="col-12 mb-2 d-flex justify-content-center align-items-center">
                                        <img src="{{ asset('storage/partner/' . $partner->image) }}" width="200px" alt="image" class="img-thumbnail-edit img-preview-edit">
                                    </div>
                                    <div class="col-12">
