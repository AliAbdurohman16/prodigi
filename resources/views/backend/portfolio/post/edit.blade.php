...
@section('title', 'Edit Postingan Portofolio')
    ...
    <div class="layout-specing">
        ...
        <div class="col-lg-12 mt-4">
            <div class="card">
                <div class="container">
                    <div class="card-body">
                        <form action="{{ route('portfolio-posts.update', $post) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="row mt-4">
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-3 mb-2 d-flex justify-content-center align-items-center">
                                                <img src="{{ asset('storage/portfolio/' . $post->image) }}" width="200px" alt="image" class="img-thumbnail img-preview">
                                            </div>
                                            <div class="col-sm-9">
                                ...
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control @error('title') is-invalid @enderror" placeholder="Judul" name="title" value="{{ $post->title }}" autocomplete="title">
                                        @error('title')
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-control select2 @error('portfolio_category_id') is-invalid @enderror" name="portfolio_category_id" id="portfolio_category_id">
                                            ...
                                            @foreach ($categories as $category)
                                                <option value="{{ $category->id }}" {{ $post->portfolio_category_id == $category->id ? 'selected' : '' }}>
                                                    {{ $category->title  }}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        ...
                                        <textarea name="description" id="summernote" class="form-control @error('description') is-invalid @enderror" placeholder="Deskripsi">{{ $post->description }}</textarea>
                                        @error('description')
