                            ...
                            <div class="row mt-4">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-3 mb-2 d-flex justify-content-center align-items-center">
                                                <img src="{{ asset('storage/service/' . $service->image) }}" width="200px" alt="image" class="img-thumbnail img-preview">
                                            </div>
                                            <div class="col-sm-9">
                                ...
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control @error('title') is-invalid @enderror" placeholder="Judul" name="title" value="{{ $service->title }}" autocomplete="title">
                                        @error('title')
                                ...
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        ...
                                        <textarea name="content" id="summernote" class="form-control @error('content') is-invalid @enderror" placeholder="Deskripsi">{{ $service->content }}</textarea>
                                        @error('content')
